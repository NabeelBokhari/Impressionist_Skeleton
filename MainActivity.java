...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggle = (ToggleButton)findViewById(R.id.buttonShuffle);
        toggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(getApplicationContext(), "Shuffle " + (isChecked ? "enabled" : "disabled"),
                        Toast.LENGTH_SHORT).show();
                _impressionistView.toggleShuffle(isChecked);
            }
        });
    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuCircleSplatter:
                ...
                return true;
            case R.id.menuSquareSplatter:
                Toast.makeText(this, "Square Splatter Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.SquareSplatter);
                return true;
        }
        return false;
    }
...
//        startActivityForResult(i, RESULT_LOAD_IMAGE);
    ...
    public void onSaveButtonClick() {
        Bitmap src = _impressionistView.getOffScreenBitmap();
        if(src != null) {
            String uri = MediaStore.Images.Media.insertImage(getContentResolver(), src,
                    "capture.png", "impression");
            if (uri != null) {
                Toast.makeText(this, "Painting Saved to Gallery", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "Painting could not be saved", Toast.LENGTH_SHORT).show();
            }
        }
    }
